...
Page({
  ...
  onPullDownRefresh: function () {
    var that = this
    that.setData({ pagesize: 1, is_loadmore: true, })
    that.getDataList()
    setTimeout(() => {
  ...
  getDataList: function () {
    var that = this
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanUser/DistributionApi/teamlist', { pagesize: that.data.pagesize, pagenum: that.data.pagenum }, (info) => {
      console.log(info)
      if (info == null) {

...
Page({
  ...
  goods_search_bind2: function (e) {
    ...
    this.setData({
      this_keywords: e.detail.value.goods_name,
      this_page_size: 1,
      select_type: '',
      select_jiage_type: '',
    })
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/Api/getCommunityConfig.html', {}, (info) => {
      ...
      if (info.is_open == 1) {
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/Api/getCateList', {}, (info) => {
          ...
          e.currentTarget.dataset = {};
          // e.currentTarget.dataset.sid = info[that.data.classifyViewed].id;
          e.currentTarget.dataset.sid = that.data.second_id;
          that.select_classify(e)
        });
      }
    }, that, { isShowLoading: false });
    ...
    if (that.data.goods_data == null) {
      requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/Api/getGoodsList', {
        ...
        if (info == null) {
          ...
          } else { that.setData({ is_loadmore: true, this_page_size: that.data.this_page_size + 1 });}
        }
        that.setData({
          goods_data: info,
          glo_is_load: false
  ...
  onReachBottom: function(e) {
    ...
    if (that.data.aaa == that.data.this_page_size){
      return false;
    }
    that.setData({ aaa: that.data.this_page_size});
    var searchData = {};
    ...
    searchData.pagesize = that.data.this_page_size;
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/Api/getGoodsList', {
      ...
      if (info == null) {
        ...
        that.setData({
          ...
          this_page_size: that.data.this_page_size + 1,
          glo_is_load: false
        });
      }

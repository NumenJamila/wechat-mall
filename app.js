...
App({
  ...
  onShow: function(options) {
    ...
    console.log('onShowoptions', options.query)
    console.log('onShowoptions', JSON.stringify(options.query))
    console.log('onShowoptions', options.query.share_uid > 0 )
    ...
    if (JSON.stringify(options.query) != '{}' && options.query.scene != undefined && options.query.scene.split('!')[1] == 'fx') {
      requestUtil.get(_DuoguanData.duoguan_user_info_url, {}, (data) => {
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/DuoguanUser/DistributionApi/make_relation.html', {
            other_openid: other_openId,
            user_openid: openId,
            path: xpath
          },
          (data) => {}, this, {});
        if (_DuoguanData.duoguan_app_is_superhome == 1) {
          if ((xpath == 'pages/giftCard/index/index' || xpath == 'pages/giftCard/getCard/getCard' || xpath == 'pages/tuan/info/info' || xpath == 'pages/tuan/join/join' || xpath == 'pages/bigcms/article/article') && xcid != undefined) {} else {
            wx.switchTab({
    ...
    if (JSON.stringify(options.query) != '{}' && options.query.sharetype != undefined && options.query.sharetype == 'fx') {
      ...
      if (options.query.shareuid > otheruid) {
        ...
        let module = options.query.module ? options.query.module : '';
        if (otheruid > 0) {
          requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/DuoguanUser/DistributionApi/CreateRelation.html', {
            otheruid: otheruid, module: module
          }, (data) => {
          }, this, {
            isShowLoading: false
          })
    ...
    if (JSON.stringify(options.query) != '{}') {
      ...
      requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/ServiceCard/Api/bindCustomer.html', {
        higher_uid: higher_uid
      }, (data) => {
        console.log(data)
      }, this, {
        isShowLoading: false
    ...
    if (JSON.stringify(options.query) != '{}' && options.query.share_uid > 0 ){

      requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanIntegral/Api/userShare.html', { share_uid: options.query.share_uid }, (data) => {
